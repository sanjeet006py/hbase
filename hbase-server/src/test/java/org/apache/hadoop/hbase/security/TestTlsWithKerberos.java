...
public class TestTlsWithKerberos {
  ...
  public static void setUp() throws Exception {
    ...
    x509TestContext = X509TestContext.newBuilder(TEST_UTIL.getConfiguration())
      .setTempDir(new File(TEST_UTIL.getDataTestDir().toUri().getPath()))
      .setKeyStorePassword("Pa$$word".toCharArray()).setKeyStoreKeyType(X509KeyType.RSA)
      .setTrustStoreKeyType(X509KeyType.RSA).setTrustStorePassword("Pa$$word".toCharArray())
      .build();
