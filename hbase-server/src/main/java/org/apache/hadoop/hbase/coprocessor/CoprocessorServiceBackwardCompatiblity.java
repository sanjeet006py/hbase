 ...
 * and {@link SingletonCoprocessorService}. From 2.0 onwards, implementors of coprocessor service
 * should also implement the relevant coprocessor class (For eg {@link MasterCoprocessor} for
 * coprocessor service in master), and override get*Service() method to return the
 * {@link com.google.protobuf.Service} object. To maintain backward compatibility with 1.0
 ...
 * maintain backward compatibility seems cleaner and more explicit.
 */
